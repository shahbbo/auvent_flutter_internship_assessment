import 'package:auvent_flutter_internship_assessment/features/home_screen/prsentation/widgets/short_cut_section.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Widget _buildPopularRestaurantsSection(BuildContext context, HomeState state) {
      ...
      children: [
        ...
        Text(
          ...
          style: AppTextStyle.instance.body12Poppins.copyWith(
              color: isActive ? const Color(0xFF8900FE) : appTheme.colorFF474B,
              height: 1.5),
        ),
      ],
    );
